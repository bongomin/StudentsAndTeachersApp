...
import { deleteStudent, editStudent, fetchStudents } from '../service/studentService';
import { useDispatch, useSelector } from 'react-redux';
import { loadStudents, removeStudent, studentToUpdate, updatedStudent } from '../store/studentSlice';
...
function Table() {
    ...
    const fetchAllStudents = async () => {
        ...
        dispatch(loadStudents(response.results))
        setLoading(false)
